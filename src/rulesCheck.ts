...
import { checkApiWithoutMethod, checkRateLimiter, checkVHtmlSanitization } from './rules/security'
...
export const checkRules = (descriptor: SFCDescriptor, filePath: string, apply: string[], override: OverrideConfig) => {
  ...
  const ruleChecks: Record<string, () => void> = {
    ...
    vHtmlSanitization: () => isVueFile && checkVHtmlSanitization(descriptor, filePath),
  }
