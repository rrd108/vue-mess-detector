...
import { reportApiWithoutMethod, reportRateLimiter, reportRuntimeConfigLeak } from './rules/security'
...
export const reportRules = (groupBy: GroupBy, sortBy: SortBy, level: OutputLevel, override: OverrideConfig) => {
  ...
  processOffenses(reportComposableFileName)
  ...
  processOffenses(reportNoAxiosFetchInNuxt)
  ...
  processOffenses(reportRuntimeConfigLeak)
